/*
  ...
  - Added the required column `paymentId` to the `Travels` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Travels" ("cityId", "createdAt", "dateEnd", "dateStart", "id", "persons", "price", "transportId", "userId") SELECT "cityId", "createdAt", "dateEnd", "dateStart", "id", "persons", "price", "transportId", "userId" FROM "Travels";
DROP TABLE "Travels";
